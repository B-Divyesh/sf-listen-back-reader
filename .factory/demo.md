...
The persistent banner provides **Reset demo** and **Start for real**. Start for
real leaves the isolated sample and opens the desktop-extension installation
steps; it does not transfer sample state into any real-data namespace.
